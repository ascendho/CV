...
% ===== 项目经历 =====
\section{项目经历}
\projentry{E-Snap 两级缓存与语义增强的智能电商客服}{}{https://github.com/zhangsan/E-Snap}{https://zhangsan.dev/projects/e-snap/demo}
\begin{itemize}
...
\projentry{VisionDoc 视觉检索驱动的多模态页证智答系统}{}{https://github.com/zhangsan/VisionDoc}{https://zhangsan.dev/projects/visiondoc/demo}
\begin{itemize}
...
\projentry{基于 SFT+GRPO 的 Wordle 反馈驱动两阶段微调}{}{https://github.com/zhangsan/Wordle}{}
\begin{itemize}
...
\section{奖项与证书}
\begin{itemize}
  \item \textbf{MOOC 认证：}自主学习大模型应用开发最新技术，并在 Coursera、Udemy、Harvard 等平台取得\ghlink{https://zhangsan.dev/\#certificates}{多项课程证书}

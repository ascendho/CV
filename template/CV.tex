...
\vspace*{-1.52cm}
\begin{center}
  {\zihao{2}\bfseries \ifpublicresume Zhang San\else 张三\fi}\\[0.4em]
...
\section{专业技能}
\begin{itemize}
  \item 熟悉 Python 及 FastAPI、LangChain 等框架，具备后端服务开发与 API 设计经验
  \item 深入理解 LLM Agent 架构与 RAG 检索技术，具备使用 LangGraph 构建复杂 Agent 工作流的经验
  \item \textbf{英语能力：}CET-6 \textbf{520} 分，能够流畅阅读英文技术文档和论文
\end{itemize}
...
\section{科研成果}
\begin{itemize}
  \item \textbf{SCI 二区在投，学生一作：}基于因果推理的异常检测框架研究
  \item \textbf{IEEE 某会议，第二作者：}跨设备数据安全验证方法研究\paperlink{https://doi.org/10.1109/example.2025.00001}
